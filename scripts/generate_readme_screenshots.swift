...
try screenshot("entry") {
    ...
    for (index, amount) in ["0원", "30,000", "50,000", "100,000", "150,000", "+1만원"].enumerated() {
    ...
    let stats = [("총 축의금", "2,300,000원"), ("총 식권", "14매"), ("총 봉투수", "7개"), ("평균 축의금", "328,571원")]
...
try screenshot("search") {
    ...
    let filters = [("이름", "김민수"), ("모임", ""), ("관계", "동료"), ("대상", "아버지"), ("최소 금액", "50,000"), ("성인 식권수", ""), ("소인 식권수", ""), ("입금방식", "전체"), ("상태", "정상")]
    ...
    let headers = ["차번", "이름", "분류", "금액", "식권", "방식", "상태", "시간", "메모", "관리"]
    var x: CGFloat = 368
    ...
    let tableRows = [
        ...
        ["계좌 1", "김민수", "회사/동료", "150,000원", "소 1", "계좌", "정상", "10:11:33", "동명이인 확인", "취소·삭제"],
...
try screenshot("summary") {
    ...
    let cards = [("총 축의금", "2,300,000원", "정상 7건 · 취소 1건"), ("평균 축의금", "328,571원", "7건 평균"), ("입금 방식", "현금 1,050,000원", "계좌 1,350,000원 · 기타 300,000원"), ("식권", "14매", "성인 12/180매 · 소인 2/20매"), ("봉투 검수", "7개", "예상 42개 · 누락 5"), ("동명이인", "1건", "김민수 2명")]
...
try screenshot("settings") {
    ...
    fieldBox("총 성인 식권수", value: "180", x: 348, y: 344, w: 240)
    fieldBox("총 소인 식권수", value: "20", x: 620, y: 344, w: 240)
    fieldBox("예상 봉투수", value: "42", x: 892, y: 344, w: 240)
